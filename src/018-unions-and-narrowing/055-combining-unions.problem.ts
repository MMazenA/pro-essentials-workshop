...
type validCodes = "200" | "201" | "204";
type invalidCodes = "400" | "401" | "404" | "500";
type HttpCode = validCodes | invalidCodes;

const handleErrorCase = (code: invalidCodes) => {
  // An imaginary function where we only handle the errors

  type test = Expect<Equal<typeof code, "400" | "401" | "404" | "500">>;
};

const handleSuccessCase = (code: validCodes) => {
